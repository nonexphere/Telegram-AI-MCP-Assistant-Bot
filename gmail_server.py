...
class GmailService:
    ...
    async def send_email(self, recipient_id: str, subject: str, message: str,) -> dict:
        """Creates and sends an email message. Usage: send_email|recipient_id=abc@xyz.com|subject=Hello|message=This is a test email."""
        try:
    ...
    async def open_email(self, email_id: str) -> str:
        """Opens email in browser given ID. Usage: open_email|email_id=abc@xyz.com"""
        try:
    ...
    async def read_email(self, email_id: str) -> dict[str, str]| str:
        """Retrieves email contents including to, from, subject, and contents. Usage: read_email|email_id=abc@xyz.com"""
        try:
    ...
    async def trash_email(self, email_id: str) -> str:
        """Moves email to trash given ID. Usage: trash_email|email_id=abc@xyz.com"""
        try:
    ...
    async def mark_email_as_read(self, email_id: str) -> str:
        """Marks email as read given ID. Usage: mark_email_as_read|email_id=abc@xyz.com"""
        try:
...
async def main():
    ...
    creds_file_path = r"D:\Projects\EAG_V1\Session8_Assignment\credentials\oauth_client.json" #os.environ.get("CREDS_FILE_PATH")
    token_path = r"D:\Projects\EAG_V1\Session8_Assignment\credentials\app_tokens.json" #os.environ.get("TOKEN_PATH")
    ...
    async def handle_list_tools() -> list[types.Tool]:
        return [
            types.Tool(
                ...
                Drafts must be approved before sending. Usage: send-email|recipient_id=abc@xyz.com|subject=Hello|message=This is a test email.""",
                inputSchema={
                    "type": "object",
                    "properties": {
                        "recipient_id": {
            ...
            types.Tool(
                ...
                Confirm before moving email to trash. Usage: trash-email|email_id=abc@xyz.com""",
                inputSchema={
                    "type": "object",
                    "properties": {
                        "email_id": {
            ...
            types.Tool(
                name="read-email",
                description="Retrieves given email content. Usage: read-email|email_id=abc@xyz.com",
                inputSchema={
                    "type": "object",
                    "properties": {
                        "email_id": {
            ...
            types.Tool(
                ...
                description="Marks given email as read. Usage: mark-email-as-read|email_id=abc@xyz.com",
                inputSchema={
                    "type": "object",
                    "properties": {
                        "email_id": {
            ...
            types.Tool(
                name="open-email",
                description="Open email in browser. Usage: open-email|email_id=abc@xyz.com",
                inputSchema={
                    "type": "object",
                    "properties": {
                        "email_id": {
